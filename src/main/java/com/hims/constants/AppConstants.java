...
public class AppConstants {
    ...
    public static final String OPD_TYPE = "OPD";
    public static final String LAB_TYPE = "LAB";
    public static final String RADIO_TYPE = "RAD";
    public static final String DENTAL_TYPE = "DENT";
    ...
    public static final String PROCEDURE_PRIORITY_ROUTINE = "ROUTINE";
