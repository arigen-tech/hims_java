...
@Service
public class StockTakingRegisterServiceImpl implements StockTakingRegisterReportService {

    private static final Logger log = LoggerFactory.getLogger(StockTakingRegisterServiceImpl.class);
    ...
    @Override
    public ResponseEntity<byte[]> generateStockTakingRegistry(Long hospitalId, Long departmentId, Date fromDate, Date toDate) {
        try {
            ...
            headers.setContentDisposition(ContentDisposition.builder("inline")
                    .filename("Stock_Taking_Register.pdf")
                    .build());
