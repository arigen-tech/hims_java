...
import com.hims.service.OpeningBalanceRegistryReportService;
...
@Service
public class OpeningBalanceRegistryReportServiceImpl implements OpeningBalanceRegistryReportService {

    private static final Logger log = LoggerFactory.getLogger(OpeningBalanceRegistryReportServiceImpl.class);
    ...
    @Override
    public ResponseEntity<byte[]> generateOpeningBalanceRegistry(Long hospitalId, Long departmentId, Date fromDate, Date toDate) {
        try {
            ...
            byte[] data = reportDeclare("Opening_Balance_Register_report", parameters, conn);

            HttpHeaders headers = new HttpHeaders();
            headers.setContentType(MediaType.APPLICATION_PDF);
            headers.setContentDisposition(ContentDisposition.builder("inline")
                    .filename("Opening_Balance_Register_report.pdf")
                    .build());
